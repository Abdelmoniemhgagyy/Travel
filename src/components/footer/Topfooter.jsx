...
function TopFooter() {
  return (
    ...
    <h3 className='btn-book-now' data-aos="fade-up"  data-aos-duration="1000">Follow me on social media</h3>
      <div className="footer-icons btn-book-now" data-aos="fade-up"  data-aos-duration="1000">
